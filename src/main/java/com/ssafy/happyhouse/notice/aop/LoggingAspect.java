package com.ssafy.happyhouse.notice.aop;
...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.happyhouse.notice.model..Notice*.*(..))")
	...
	@Around(value = "execution(* com.ssafy.happyhouse.notice.model..Notice*.*(..))")
	...
	@AfterReturning(value = "execution(* com.ssafy.happyhouse.notice.model..Notice*.list*(..))", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.happyhouse.notice.model..Notice*.list*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.happyhouse.notice.model..Notice*.list*(..))")
